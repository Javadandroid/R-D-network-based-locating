...
import { Pin, RulerState, MapCircle, LatLng } from '../types';
import { getIconHtml } from './MapIcons';

interface MapViewProps {
  pins: Pin[];
  circles?: MapCircle[]; // Existing circles
  drawingCircle?: { center: LatLng; radius: number; color: string } | null; // Circle currently being drawn
